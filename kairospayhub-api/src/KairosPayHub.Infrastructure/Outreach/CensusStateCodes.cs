...
public static class CensusStateCodes
{
    private static readonly Dictionary<string, string> Fips = new(StringComparer.OrdinalIgnoreCase)
    {
        ["AL"] = "01", ["Alabama"] = "01",
        ["AK"] = "02", ["Alaska"] = "02",
        ["AZ"] = "04", ["Arizona"] = "04",
    ...
    public static bool TryGetFips(string state, out string fips) =>
        Fips.TryGetValue(state.Trim(), out fips!);
}
