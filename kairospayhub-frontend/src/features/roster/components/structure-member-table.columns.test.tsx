...
import { StructureMemberTable } from '@/features/roster/components/structure-member-table'
import { MemberTableToolbar } from '@/features/roster/components/member-table-toolbar'
import { defaultMembershipColumnVisibility } from '@/features/roster/lib/membership-table-columns'
...
describe('membership phone list', () => {
  it('shows cards and opens omitted profile columns in a details modal', async () => {
