...
import { CreateProgramWizard } from '@/features/giving/components/create-program-wizard'
import {
  GivingCampaignConfirmModal,
  type CampaignConfirmAction,
} from '@/features/giving/components/giving-campaign-confirm-modal'
import type { CampaignAction } from '@/features/giving/components/giving-campaign-actions-menu'
import {
  campaignStatsByProgramId,
  deriveGivingMetrics,
  GivingTopMetrics,
  givingsPageDescription,
} from '@/features/giving/components/giving-metrics'
import { GivingTable, type GivingTableRow } from '@/features/giving/components/giving-table'
