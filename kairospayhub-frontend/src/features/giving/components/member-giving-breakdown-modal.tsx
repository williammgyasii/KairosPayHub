...
import type { Contribution, GivingProgram } from '@/features/giving/api'
import { formatAmount, listMemberContributions } from '@/features/giving/api'
import type { StructureTree } from '@/api/structure'
import { nodeById, parentChain } from '@/shared/lib/structure-tree'
import { ContributionDetailModal } from '@/features/giving/components/contribution-detail-modal'
import { LegacyParentContributionBadge } from '@/features/giving/components/giving-badges'
