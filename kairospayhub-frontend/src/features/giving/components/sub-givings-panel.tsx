...
import { programCreatorLabel, subCampaignLogStatus } from '@/features/giving/lib/giving-ui'
        ...
        {rows.length === 0 ? (
          ...
          <PhoneList
            ...
            items={rows.map((row) => ({
              ...
              ...labeledPhoneCard(
                row.title,
                [row.periodLabel, row.status],
                [
                  { label: 'Title', value: row.title },
                  { label: 'Event', value: row.periodLabel },
                  { label: 'Status', value: row.status },
                  { label: 'Scope', value: row.scopeKind },
